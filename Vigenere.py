...
class Vigenere(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
    ...
    def open_input_file(self, function: str):
    ...
    def open_output_file(self, function: str):
        filename = self.open_file_dialog_box()
        if function == 'encrypt':
            if filename == '':
    ...
    def functions(self):
        ...
        self.OutputFile_btn.clicked.connect(lambda: self.open_output_file('decrypt'))
        self.InputFile_btn.clicked.connect(lambda: self.open_input_file('decrypt'))
        self.OutputFile_btn_2.clicked.connect(lambda: self.open_output_file('encrypt'))
        self.InputFile_btn_2.clicked.connect(lambda: self.open_input_file('encrypt'))
